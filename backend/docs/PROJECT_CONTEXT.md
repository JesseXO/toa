# TOA Fit-Aware Commerce — Project Context for Thesis
...
The output replaces the hand-coded coefficients in the FE's [`measurements.js`](../../app/src/routes/onboarding/inference/measurements.js).
