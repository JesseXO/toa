# TOA Fit-Aware Commerce — Evaluation, Datasets & Validation Roadmap
...
Three structural changes in [`landmarks.js`](../../app/src/routes/onboarding/inference/landmarks.js):
...
1. **Crawl ~5,000 products** across the four TOA categories (Shirts & Tops, Pants & Bottoms, Outerwear, Accessories), using their public API or polite scraping with `robots.txt` compliance and a 1-req/s rate limit.
